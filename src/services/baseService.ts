...
export default class BaseService {
  ...
  async get(url: string, queryParams: any = null) {
    return trackPromise(
      client.get(this.getUrl(url) + this.mapQueryParams(queryParams), {
  ...
  async post(url: string, body: any, queryParams: any = null) {
    return trackPromise(
      client.post(this.getUrl(url) + this.mapQueryParams(queryParams), body, {
        method: 'POST',
        headers: this.headers,
      })
    )
  ...
  async patch(url: string, body: any, queryParams: any = null) {
    return trackPromise(
      client.patch(this.getUrl(url) + this.mapQueryParams(queryParams), body, {
        headers: this.headers,
      })
    )
  }
  ...
  async put(url: string, body: any, queryParams: any = null) {
    return trackPromise(
      client.put(this.getUrl(url) + this.mapQueryParams(queryParams), body, {
        method: 'PUT',
        headers: this.headers,
      })
    )
  ...
  async remove(url: string, queryParams: any = null) {
    return trackPromise(
      client.delete(this.getUrl(url) + this.mapQueryParams(queryParams), {
        method: 'DELETE',
        headers: this.headers,
      })
    )
